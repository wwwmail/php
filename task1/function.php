...
function get_files_list($dir){
        ...
        $directory = new DirectoryIterator($dir) or die("getFileList: Failed opening directory $dir for reading");
        $i = 0;        
...
if (isset($_FILES)){
        ...
        $a = check_downloads_dir(DOWNLOAD_DIR);
